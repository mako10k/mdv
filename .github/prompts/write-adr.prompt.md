---
description: "Use when drafting or updating an ADR for architecture, IPC contracts, packaging strategy, workflow rules, or long-lived technical decisions in this repo."
name: "write-adr"
argument-hint: "Describe the decision, affected files, and whether this is a new ADR or an update/supersession."
agent: "agent"
tools: [read, search, edit]
---
Draft or update an ADR for this repository.
